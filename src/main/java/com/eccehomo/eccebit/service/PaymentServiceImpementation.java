...
import com.eccehomo.eccebit.repository.PaymentOrderRepository;
...
public class PaymentServiceImpementation implements PaymentService{
    ...
    @Override
    public PaymentOrder createOrder(User user, Long amount, PaymentApp paymentApp) {
        PaymentOrder order=new PaymentOrder();
        order.setUser(user);
        order.setAmount(amount);
        order.setPaymentApp(paymentApp);
    ...
    public Boolean ProccedPaymentOrder(PaymentOrder paymentOrder,String paymentId) throws RazorpayException {
        if(paymentOrder.getStatus().equals(PaymentOrderStatus.PENDING)){
            ...
            if(paymentOrder.getPaymentApp().equals(PaymentApp.RAZORPAY)){
