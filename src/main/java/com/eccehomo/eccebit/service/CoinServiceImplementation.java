...
import com.eccehomo.eccebit.repository.CoinRepository;
...
public class CoinServiceImplementation implements CoinService{
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=jpy&per_page=10&page="+page;
    ...
    public String getMarketChart(String coinId, int days) throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/"+coinId+"/market_chart?vs_currency=jpy&days="+days;
...
//        coinRepository.save(coins);
        ...
        coin.setCurrentPrice(marketData.get("current_price").get("jpy").asDouble());
        coin.setMarketCap(marketData.get("market_cap").get("jpy").asLong());
        coin.setMarketCapRank(jsonNode.get("market_cap_rank").asInt());
        coin.setTotalVolume(marketData.get("total_volume").get("jpy").asLong());
        coin.setHigh24h(marketData.get("high_24h").get("jpy").asDouble());
        coin.setLow24h(marketData.get("low_24h").get("jpy").asDouble());
